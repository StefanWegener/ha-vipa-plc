...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Reload the integration when options change (e.g. entity edits).
    # This replaces OptionsFlowWithReload to ensure options are fully
    # persisted to .storage before the reload is triggered.
